/**
  ******************************************************************************
  * @file    harsh_detection_prototype.h
  ...
  ******************************************************************************
  */
#ifndef AI_HARSH_DETECTION_PROTOTYPE_H
#define AI_HARSH_DETECTION_PROTOTYPE_H

#include "harsh_detection_prototype_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_HARSH_DETECTION_PROTOTYPE_MODEL_NAME          "harsh_detection_prototype"
#define AI_HARSH_DETECTION_PROTOTYPE_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_HARSH_DETECTION_PROTOTYPE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_HARSH_DETECTION_PROTOTYPE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_HARSH_DETECTION_PROTOTYPE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_HARSH_DETECTION_PROTOTYPE_IN_NUM        (1)

AI_DEPRECATED
#define AI_HARSH_DETECTION_PROTOTYPE_IN \
  ai_harsh_detection_prototype_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HARSH_DETECTION_PROTOTYPE_IN_SIZE { \
  AI_HARSH_DETECTION_PROTOTYPE_IN_1_SIZE, \
}
#define AI_HARSH_DETECTION_PROTOTYPE_IN_SIZE_BYTES { \
  AI_HARSH_DETECTION_PROTOTYPE_IN_1_SIZE_BYTES, \
}
#define AI_HARSH_DETECTION_PROTOTYPE_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HARSH_DETECTION_PROTOTYPE_IN_1_HEIGHT      (40)
#define AI_HARSH_DETECTION_PROTOTYPE_IN_1_CHANNEL     (6)
#define AI_HARSH_DETECTION_PROTOTYPE_IN_1_SIZE        (240)
#define AI_HARSH_DETECTION_PROTOTYPE_IN_1_SIZE_BYTES  (240)

/******************************************************************************/
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_HARSH_DETECTION_PROTOTYPE_OUT \
  ai_harsh_detection_prototype_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HARSH_DETECTION_PROTOTYPE_OUT_SIZE { \
  AI_HARSH_DETECTION_PROTOTYPE_OUT_1_SIZE, \
}
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_SIZE_BYTES { \
  AI_HARSH_DETECTION_PROTOTYPE_OUT_1_SIZE_BYTES, \
}
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_1_CHANNEL     (5)
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_1_SIZE        (5)
#define AI_HARSH_DETECTION_PROTOTYPE_OUT_1_SIZE_BYTES  (5)

/******************************************************************************/
#define AI_HARSH_DETECTION_PROTOTYPE_N_NODES (11)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup harsh_detection_prototype
 ...
 * @ingroup harsh_detection_prototype
 ...
 * @ref ai_harsh_detection_prototype_create. Both the activations memory buffer 
 ...
 * using @ref ai_harsh_detection_prototype_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_harsh_detection_prototype_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_harsh_detection_prototype_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HARSH_DETECTION_PROTOTYPE_*
 * defines into file @ref harsh_detection_prototype.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_harsh_detection_prototype_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_HARSH_DETECTION_PROTOTYPE_H */
