...
#define AI_SINE_MODEL_SIGNATURE     "011b10f421415eaceec6fa2524cf429c"
...
#define AI_TOOLS_DATE_TIME   "Wed Apr 22 19:52:04 2026"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_210_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_210_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 1), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &serving_default_keras_tensor_210_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_210_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 256, 1,
                     NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_IN_NUM, &serving_default_keras_tensor_210_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_OUT_NUM, &dense_2_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    serving_default_keras_tensor_210_output_array.data = AI_PTR(NULL);
    serving_default_keras_tensor_210_output_array.data_start = AI_PTR(NULL);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_0_bias_array.data = AI_PTR(weights_map[0] + 128);
    dense_0_bias_array.data_start = AI_PTR(weights_map[0] + 128);
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(weights_map[0] + 256);
    dense_1_weights_array.data_start = AI_PTR(weights_map[0] + 256);
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(weights_map[0] + 4352);
    dense_1_bias_array.data_start = AI_PTR(weights_map[0] + 4352);
    dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_weights_array.data = AI_PTR(weights_map[0] + 4480);
    dense_2_weights_array.data_start = AI_PTR(weights_map[0] + 4480);
    dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_bias_array.data = AI_PTR(weights_map[0] + 4608);
    dense_2_bias_array.data_start = AI_PTR(weights_map[0] + 4608);
    return true;
  }
  return false;
}
