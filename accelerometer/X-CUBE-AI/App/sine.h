...
#define AI_SINE_ORIGIN_MODEL_NAME   "sine_model"
...
/******************************************************************************/
#define AI_SINE_IN_NUM        (1)
#define AI_SINE_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_IN_SIZE { \
  AI_SINE_IN_1_SIZE, \
}
#define AI_SINE_IN_SIZE_BYTES { \
  AI_SINE_IN_1_SIZE_BYTES, \
}
#define AI_SINE_IN_1_CHANNEL     (1)
#define AI_SINE_IN_1_SIZE        (1)
#define AI_SINE_IN_1_SIZE_BYTES  (AI_SINE_IN_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_OUT_NUM       (1)
#define AI_SINE_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 1, 1, NULL), \
}
#define AI_SINE_OUT_SIZE { \
  AI_SINE_OUT_1_SIZE, \
}
#define AI_SINE_OUT_SIZE_BYTES { \
  AI_SINE_OUT_1_SIZE_BYTES, \
}
#define AI_SINE_OUT_1_CHANNEL     (1)
#define AI_SINE_OUT_1_SIZE        (1)
#define AI_SINE_OUT_1_SIZE_BYTES  (AI_SINE_OUT_1_SIZE * 4)

/******************************************************************************/
#define AI_SINE_N_NODES (5)
 ...
 * @ref ai_sine_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_SINE_*
 * defines into file @ref sine.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
